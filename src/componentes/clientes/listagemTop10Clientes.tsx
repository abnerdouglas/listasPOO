...
const ListagemTop10Clientes = () => {
  ...
  return (
    <div className="container">
      <h5><strong>Listagem dos 10 Maiores Clientes Consumidores de Serviços e Produtos</strong></h5>
      <hr />
...
export default ListagemTop10Clientes;
